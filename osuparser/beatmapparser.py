...
class BeatmapParser():
    ...
    def parse_hit_object(self, line):
        ...
        if object_type & 1:
            ...
            end_point = slidercalc.get_end_point(hit_object["curveType"], hit_object["pixelLength"],
                                                 hit_object["points"])
            if end_point != "undefined" and end_point[0] and end_point[1]:
    ...
    def parse_event(self, line):
        ...
        elif members[0] == '2' and members[1].isnumeric() and  members[2].isnumeric():
    ...
    def build_beatmap(self):
        ...
        for object_line in self.object_lines:
            ##extreme workarround
            if object_line.startswith("osu file format"):
                continue
